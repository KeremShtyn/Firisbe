...
public enum ErrorCodes implements ErrorCode {
    ...
    THIS_EMAIL_HAS_TAKEN_BEFORE(100,"ErrorCodes.THIS_EMAIL_HAS_TAKEN_BEFORE",HttpStatus.BAD_REQUEST),
    THIS_CREDIT_CARD_HAS_TAKEN_BEFORE(100,"ErrorCodes.THIS_CREDIT_CARD_HAS_TAKEN_BEFORE",HttpStatus.BAD_REQUEST),
